	...
	<div class="login-html">
		...
		<div class="login-form">
			<div class="sign-in-htm">
				<div class="group">
					...
					<input id="user" type="text" class="input" v-model="login.username" />
				</div>
				<div class="group">
					<label for="pass" class="label">Password</label>
					<input id="pass" type="password" class="input" data-type="password" v-model="login.password" />
				</div>
				<div class="group">
				...
				<div class="group">
					<input type="submit" class="button" value="Sign In" @keyup.13="loginNow" @click="loginNow">
				</div>
				<div class="hr"></div>
				<div class="foot-lnk">
      ...
      <div class="sign-up-htm">
				<div class="group">
					...
					<input id="user" type="text" class="input" v-model="registerUser.email">
				</div>
				<div class="group">
					<label for="pass" class="label">Password</label>
					<input id="pass" type="password" class="input" data-type="password" v-model="registerUser.password">
				</div>
				<div class="group">
					<label for="pass" class="label">Username</label>
					<input id="pass" class="input"  v-model="registerUser.username">
				</div>
				<div class="group">
					<label for="pass" class="label">Phonenumber</label>
					<input id="pass" type="text" class="input" v-model="registerUser.phoneNumber">
				</div>
				<div class="group">
